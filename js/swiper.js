  ...
  var S = {
    ...
    updateSlides: function () {
      ...
      if (
        ...
        const t = `${a.containerModifierClass}bacexpace-hidden`,
          s = e.$el.hasClass(t);
        p <= a.maxBacexpaceHiddenSlides
          ? s || e.$el.addClass(t)
  ...
  function se(e, t) {
    return e.transformEl
      ? t
          .find(e.transformEl)
          .css({
            'bacexpace-visibility': 'hidden',
            '-webkit-bacexpace-visibility': 'hidden',
          })
      : t;
  }
  function ae(e) {
